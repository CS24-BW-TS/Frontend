...
import { MapContext, addRoom } from '../state/StateManagement'
  ...
  return (
    <div className='user-info'>
      <form className='user-form'>
        ...
        <Button variant='contained' color='primary' onClick={() => moveTo('n')}>
          Move North
        </Button>
        <Button variant='contained' color='primary' onClick={() => moveTo('e')}>
          Move East
        </Button>
        <Button variant='contained' color='primary' onClick={() => moveTo('s')}>
          Move South
        </Button>
        <Button variant='contained' color='primary' onClick={() => moveTo('w')}>
          Move West
        </Button>
        <Button variant='contained' color='secondary'>
          Run Algorithm
        </Button>
        <Button variant='contained' color='secondary' onClick={playerStatus}>
          Player Status
        </Button>
        <br />
        <div className='form-side'>
          <div>
            <TextField
              ...
              label='Take What?'
              value={takeF}
              onChange={e => updateVal(e, setTake)}
            />
            <Button variant='contained' onClick={takeItem}>
              Take
            </Button>
          </div>
          <br />
          <div>
            <TextField
              ...
              label='Drop What?'
              value={dropF}
              onChange={e => updateVal(e, setDrop)}
            />
            <Button variant='contained' onClick={dropItem}>
              Drop
            </Button>
          </div>
          <br />
          <div>
            <TextField
              ...
              label='Wear What?'
              value={wearF}
              onChange={e => updateVal(e, setWear)}
            />
            <Button variant='contained' onClick={wearItem}>
              Wear
            </Button>
          </div>
          <br />
          <div>
            <TextField
              ...
              label='Unequip What?'
              value={unequipF}
              onChange={e => updateVal(e, setUnequip)}
            />
            <Button variant='contained' onClick={undressItem}>
              Unequip
            </Button>
          </div>
          <br />
          <div>
            <TextField
              ...
              label='Examine What?'
              value={examineF}
              onChange={e => updateVal(e, setExamine)}
            />
            <Button variant='contained' onClick={examineItem}>
              Examine
            </Button>
          </div>
          <br />
          <div>
            <TextField
              ...
              label='New Name'
              value={nameF}
              onChange={e => updateVal(e, setName)}
            />
        ...
        <TextField
          ...
          label='Carry What?'
          value={carryF}
          onChange={e => updateVal(e, setCarry)}
        />
        <Button variant='contained' onClick={carryItem}>
          Carry (Companion)
        </Button>
        <Button variant='contained' color='secondary' onClick={receiveItem}>
          {' '}
          Receive (Companion)
        </Button>
        <br />
        <TextField
          ...
          label='Sell What?'
          value={sellF}
          onChange={e => updateVal(e, setSell)}
        />
        <Button variant='contained' onClick={sellItem}>
          Sell
        </Button>
        <Button variant='contained' onClick={e => confirmSellItem(e, 'yes')}>
          Confirm Sale
        </Button>
        <Button variant='contained' onClick={e => confirmSellItem(e, 'no')}>
          Cancel Sale
        </Button>
        <Button variant='contained' onClick={autoSellItem}>
          Auto Sell
        </Button>
        <br />
        {/* Should only let the pray button appear when we're at a shrine */}
        <Button variant='contained' onClick={prayShrine}>
          Pray
        </Button>
      </form>
    </div>
